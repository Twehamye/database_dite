	  ...
	  <div class="container-fluid">
	    <ul class="navbar-nav">
	      ...
	      <li class="nav-item dropdown">
	        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Actions</a>
	        <ul class="dropdown-menu">
			    ...
			    <li><a class="dropdown-item" href="add_loan.php">Add Loan </a></li>
			</ul>
	      </li>
	      <li class="nav-item dropdown">
	     ...
	     <li class="nav-item dropdown">
		  ...
		  <ul class="dropdown-menu">
		    <li><a class="dropdown-item" href="select_all_staff.php">All Staff</a></li>
		    <li><a class="dropdown-item" href="select_all_borrower.php">All Customers</a></li>
		    <li><a class="dropdown-item" href="select_all_loans.php">All Loans</a></li>
		  </ul>
		 </li> 
		</ul>
	   </div>
